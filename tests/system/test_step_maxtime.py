...
class TestStepMaxTime(unittest.TestCase):
    ...
    def test_step_maxtime_for_real(self):
        """Test short step maxtimes."""
    ...
    def test_step_maxtime_invalid_type(self):
        """Test configurable step maxtimes with invalid value."""
        conf = {'MAX_STEP_DURATION': '1400'}
        with Cluster(extra_conf=conf) as cluster:
            local_repo = cluster.clone()
            local_repo.push(
    ...
    def test_step_maxtime_too_long(self):
        """Test configurable step maxtimes too high."""
        conf = {'MAX_STEP_DURATION': '1400'}
        with Cluster(extra_conf=conf) as cluster:
            local_repo = cluster.clone()
            local_repo.push(
