...
class TestUpload(testutil.BuildStepMixin, unittest.TestCase,
    ...
    def test_retry_arg(self):
        """Tests that the retry constructor arg is stored in the class"""
